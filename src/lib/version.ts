...
export const APP_BUILD_DATE = "2026-03-31";

// Version history:
// 1.0.0 — Phases 1-7: Foundation, Inventory, Financials, Analytics, MCP, Data Migration, Automation
// 1.1.0 — Telegram bot, Vault sync, Vercel deployment
